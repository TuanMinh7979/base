...
function loadAttributeToForm(editAttributeBtn, url) {
...
function renderDataForAttributeTable(data, deleteAUrl) {
    let rs = "";
    ...
    data.map(function (atbi) {
        ...
        rs += `       <tr>
                ...
                <td class="col-3">
                    ...
                    <a class="btn btn-danger tag_delete_one"  href=${deleteAUrl} >Delete</a>
...
function callAttributeApi(url, deleteAUrl) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            renderDataForAttributeTable(data, deleteAUrl);
        },
        error: function () {
            Swal.fire({
                icon: 'error',
...
//         if (editMode == "Detail") {
//
//             callAttributeApi(`/admin/category/api/${mainId}/attributes`, `/admin/category/api/${mainId}/attributes/delete`);
...
//                 event.preventDefault();
//                 saveAttribute(this, `/admin/category/api/${mainId}/attributes/add`);
//
//             });
//             $("#updateAttributeBtn").on("click", function (event) {
//                 event.preventDefault();
//                 saveAttribute(this, `/admin/category/api/${mainId}/attributes/update`);
//
//             });
...
//     event.preventDefault();
//     //load data first
//     loadAttributeToForm(this, `/admin/category/api/${mainId}/attributes/value`);
